...
const FixedWhatsapp = () => {
  ...
  return (
    <div className="fixedWhatsapp" role="presentation" style={(scrollPosition < 400 || screenWidth < 768)? {display: "none"}: {display: "flex"}}>
      <svg
      ...
      >
        ...
        ></path>
        <path
          className="ic-c-whatsapp_svg__ic_c_whatsapp"
          fill="#fff"
      ...
      <div className="fixedWhatsappLabel">Whatsapp Us</div>
    </div>
  );
};
