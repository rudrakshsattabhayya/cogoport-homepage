...
const BiggerGetStartedSection = () => {
    return (
                <div className="biggerGetStartedSection">
                    <div className="biggerGetStartedSectionLeft">
                        <h2 className="biggerGetStartedSectionHeading">
                            Get Started Today
                        </h2>
                        <div className="biggerGetStartedSectionDescription">
                        <p>Plan, Book and Finance your shipment in one place.</p><br />
                            Experience how Cogoport’s Global Trade Platform can Turbocharge your Business.
                        </div>
                        <a>
                            <button className="redBtn biggerGetStartedSectionButton" style={{padding: "8px 35px", marginTop: "20px", display: "inline-block", height: "40px"}}>Get Started</button>
                        </a>
                    </div>
